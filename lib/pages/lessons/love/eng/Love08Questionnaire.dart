...
class Love08Questionnaire extends StatefulWidget {
  const Love08Questionnaire({super.key});

  @override
  State<Love08Questionnaire> createState() => _Love08QuestionnaireState();
}

class _Love08QuestionnaireState extends State<Love08Questionnaire> {
  ...
  final  answer_6_8 = TextEditingController();
  ...
  void loadData() async{
    lessonData = await sqlHelper.getLessonByID(8);
    ...
    if(colAns1.length>1){
      ...
      answer_6_7.text = colAns1[6];
      answer_6_8.text = colAns1[7];
    }
    setState(() {
    });
  }
  ...
  void updateAnswers() async{
    ...
    String ans6 = answer_6_1.text + "~" + answer_6_2.text + "~" + answer_6_3.text + "~" + answer_6_4.text + "~" + answer_6_5.text + "~" + answer_6_6.text + "~" + answer_6_7.text + "~" + answer_6_8.text;
    ...
    if(answer_5.text.trim()!='')
      completionCounter+=1;
    if(answer_6_1.text.trim()!='' && answer_6_2.text.trim()!='' &&  answer_6_3.text.trim()!='' &&  answer_6_4.text.trim()!='' &&  answer_6_5.text.trim()!='' &&  answer_6_6.text.trim()!='' &&  answer_6_7.text.trim()!='' &&  answer_6_8.text.trim()!='')
      completionCounter+=1;
  ...
  Widget build(BuildContext context) {
    ...
    clsRichTextFormatter(content:LoveQuestionnaire08.question_1(language),fontStyle: FontStyle.normal, fontWeight: FontWeight.normal, bColor: '', fontSize: fontSize, isDarkMode: isDarkMode),
    ...
    List<clsRichTextFormatter> question_02 = [
      clsRichTextFormatter(content:LoveQuestionnaire08.question_2(language),fontStyle: FontStyle.normal, fontWeight: FontWeight.normal, bColor: '', fontSize: fontSize, isDarkMode: isDarkMode),
      clsRichTextFormatter(content:'',fontStyle: FontStyle.italic, fontWeight: FontWeight.normal, bColor: colorTheme, fontSize: fontSize, isDarkMode: isDarkMode),
    ];
    List<clsRichTextFormatter> question_03 = [
      clsRichTextFormatter(content:LoveQuestionnaire08.question_3(language),fontStyle: FontStyle.normal, fontWeight: FontWeight.normal, bColor: '', fontSize: fontSize, isDarkMode: isDarkMode),
      clsRichTextFormatter(content:'',fontStyle: FontStyle.italic, fontWeight: FontWeight.normal, bColor: colorTheme, fontSize: fontSize, isDarkMode: isDarkMode),
    ];
    List<clsRichTextFormatter> question_04 = [
      clsRichTextFormatter(content:LoveQuestionnaire08.question_4(language),fontStyle: FontStyle.normal, fontWeight: FontWeight.normal, bColor: '', fontSize: fontSize, isDarkMode: isDarkMode),
      clsRichTextFormatter(content:'',fontStyle: FontStyle.italic, fontWeight: FontWeight.normal, bColor: colorTheme, fontSize: fontSize, isDarkMode: isDarkMode),
    ];
    List<clsRichTextFormatter> question_05 = [
      clsRichTextFormatter(content:LoveQuestionnaire08.question_5(language),fontStyle: FontStyle.normal, fontWeight: FontWeight.normal, bColor: '', fontSize: fontSize, isDarkMode: isDarkMode),
      clsRichTextFormatter(content:'',fontStyle: FontStyle.italic, fontWeight: FontWeight.normal, bColor: colorTheme, fontSize: fontSize, isDarkMode: isDarkMode),
    ];
    List<clsRichTextFormatter> question_06 = [
      clsRichTextFormatter(content:LoveQuestionnaire08.question_6(language),fontStyle: FontStyle.normal, fontWeight: FontWeight.normal, bColor: '', fontSize: fontSize, isDarkMode: isDarkMode),
      clsRichTextFormatter(content:'',fontStyle: FontStyle.italic, fontWeight: FontWeight.normal, bColor: colorTheme, fontSize: fontSize, isDarkMode: isDarkMode),
    ];
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(clsLanguagePreset.app_bar_label_love_questionnaire(language)  + ' 8'),
              ...
              child: SingleChildScrollView(
                child: SafeArea(
                  child: Column(
                    ...
                    children: [
                      getHeadings(clsLanguagePreset.headings_activity_questionnaire(language) +  ' 8'),
                      ...
                      MultiInputField(controller: answer_2, hint: clsLanguagePreset.hint_enter_your_answer(language),maxLines: 4, colorTheme: colorTheme, fontSize: fontSize),
                      ...
                      MultiInputField(controller: answer_4, hint: clsLanguagePreset.hint_enter_your_answer(language),maxLines: 4, colorTheme: colorTheme, fontSize: fontSize),
                      ...
                      SingleLabelInputField(controller: answer_6_1, label: '1.', hint: clsLanguagePreset.hint_enter_your_answer(language), colorTheme: colorTheme, indentPadding: 10, fontSize: fontSize),
                      SingleLabelInputField(controller: answer_6_2, label: '2.', hint: clsLanguagePreset.hint_enter_your_answer(language), colorTheme: colorTheme, indentPadding: 10, fontSize: fontSize),
                      SingleLabelInputField(controller: answer_6_3, label: '3.', hint: clsLanguagePreset.hint_enter_your_answer(language), colorTheme: colorTheme, indentPadding: 10, fontSize: fontSize),
                      SingleLabelInputField(controller: answer_6_4, label: '4.', hint: clsLanguagePreset.hint_enter_your_answer(language), colorTheme: colorTheme, indentPadding: 10, fontSize: fontSize),
                      SingleLabelInputField(controller: answer_6_5, label: '5.', hint: clsLanguagePreset.hint_enter_your_answer(language), colorTheme: colorTheme, indentPadding: 10, fontSize: fontSize),
                      SingleLabelInputField(controller: answer_6_6, label: '6.', hint: clsLanguagePreset.hint_enter_your_answer(language), colorTheme: colorTheme, indentPadding: 10, fontSize: fontSize),
                      SingleLabelInputField(controller: answer_6_7, label: '7.', hint: clsLanguagePreset.hint_enter_your_answer(language), colorTheme: colorTheme, indentPadding: 10, fontSize: fontSize),
                      SingleLabelInputField(controller: answer_6_8, label: '8.', hint: clsLanguagePreset.hint_enter_your_answer(language), colorTheme: colorTheme, indentPadding: 10, fontSize: fontSize),
                      SizedBox(height: 100,)
                    ],
                  ),
                ),
