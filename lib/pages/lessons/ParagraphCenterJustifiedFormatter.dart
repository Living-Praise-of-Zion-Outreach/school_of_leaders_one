...
class ParagraphCenterJustifiedFormatter extends StatelessWidget {
  final List<clsRichTextFormatter> richTextData;
  final double marginGap;
  const ParagraphCenterJustifiedFormatter({super.key,required this.richTextData,required this.marginGap});
