...
import 'package:school_of_leaders_one/models/ModelPanelWeek.dart';
import 'package:school_of_leaders_one/models/ModelPanelWeekDay.dart';
...
class DailyVerseList extends StatefulWidget {
  const DailyVerseList({super.key});

  @override
  State<DailyVerseList> createState() => _DailyVerseListState();
}
...
class _DailyVerseListState extends State<DailyVerseList> {
  ...
  Widget createPanelHeader(String title, double completionRate){
    if(completionRate==100){
        return Row(children: [
          Text(title,style: TextStyle(fontSize: fontSize,fontWeight: FontWeight.bold, color:myThemes.getColor(colorTheme))),
                ...
                child: Container(
                    ...
                    child:Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('DAY ' + _data[startIndex].dayNo.toString(),style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold, color: myThemes.getColor(colorTheme))),
                ...
                child: Container(
                    ...
                    child:Padding(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('DAY ' + _data[startIndex+1].dayNo.toString(),style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold, color: myThemes.getColor(colorTheme))),
                          //Text('100.00%'),
                          //Icon(Icons.watch_later_rounded, color: Colors.amber,),
                ...
                child: Container(
                    ...
                    child:Padding(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          Text('DAY ' + _data[startIndex+2].dayNo.toString(),style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold, color: myThemes.getColor(colorTheme))),
