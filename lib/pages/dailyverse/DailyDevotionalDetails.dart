...
class DailyDevotionalDetails extends StatefulWidget {
  const DailyDevotionalDetails({super.key});

  @override
  State<DailyDevotionalDetails> createState() => _DailyDevotionalDetailsState();
}
      ...
      body: SingleChildScrollView(
        child: Padding(padding:EdgeInsets.all(10.0),
          child: Column(
            ...
            children: [
            Text('I. RHEMA',textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color:myThemes.getColor(colorTheme))),
            SizedBox(height: 10.0,),
              ...
              Divider(),
              Text('II. COMMANDS',textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color:myThemes.getColor(colorTheme))),
              TextField(
                keyboardType: TextInputType.multiline,
                maxLines: 10,
                ...
                style: TextStyle(fontSize: 16),),
              Divider(),
              Text('III. WARNINGS',textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color:myThemes.getColor(colorTheme))),
              TextField(
                keyboardType: TextInputType.multiline,
                maxLines: 10,
                ...
                style: TextStyle(fontSize: 16),),
              Divider(),
              Text('IV. PROMISES',textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color:myThemes.getColor(colorTheme))),
              TextField(
                keyboardType: TextInputType.multiline,
                maxLines: 10,
                ...
                style: TextStyle(fontSize: 16),),
              Divider(),
              Text('V. APPLICATION',textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color:myThemes.getColor(colorTheme))),
              TextField(
                keyboardType: TextInputType.multiline,
                maxLines: 10,
