...
import 'package:school_of_leaders_one/widgets/DailyVerseTextGenerator.dart';
import '../models/modelBibleVerse.dart';
import '../pages/dailyverse/DailyVerseDetails.dart';
    ...
    return SafeArea(
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
              children: [
            Center(child: Text(data.long_name + " " + data.chapter,textAlign: TextAlign.center,  style: TextStyle(fontWeight: FontWeight.bold,fontSize: fontSize+2,color: myThemes.getColor(colorTheme))))
                ,
                SizedBox(height: 20,)
                ,
                Column(
