    ...
    if(blnFound){
        ...
        return InkWell(
          ...
          child: StyledText(text: '<u>' + data.verse.toString() + '</u> ' +
            ...
            style: TextStyle(fontSize: fontSize,
                ...
                backgroundColor: myThemes.getShade100Color(colors)),
        ...
        return InkWell(
          ...
          child: StyledText(text: '<u>' + data.verse.toString() + '</u> ' +
            ...
            style: TextStyle(fontSize: fontSize,
                ...
                decorationThickness: 3,
                decorationStyle: TextDecorationStyle.dotted,
                backgroundColor: myThemes.getShade100Color(color)),
            tags: defaultStyledTextTags ,
          ),);
      }
    }
      ...
      return InkWell(
        ...
        child: StyledText(text: '<u>' + data.verse.toString() + '</u> ' +
          ...
          style: TextStyle(fontSize: fontSize,height: 2,backgroundColor: myThemes.getShade100Color(colors)),
          tags: defaultStyledTextTags ,
        ),);
